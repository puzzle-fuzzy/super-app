        ...
        {loading ? (
          ...
          <div className="grid place-items-center py-20">
            <div className="max-w-105 text-center">
              <h3 className="mb-2.5 text-[18px] font-semibold tracking-[-0.02em]">还没有流水线项目</h3>
          ...
          <div className="grid grid-cols-3 gap-3.5 max-[1100px]:grid-cols-2 max-[680px]:grid-cols-1">
            {projects.map((project) => (
              ...
              >
                ...
                <h3 className={`mb-2.5 text-xl font-semibold tracking-[-0.02em] ${project.finalVideoUrl ? 'mt-1' : 'mt-10.5'}`}>
                  {project.title || '未命名项目'}
                </h3>
      ...
      {createOpen && (
        <DialogOverlay onClose={() => setCreateOpen(false)}>
          <div className="w-full max-w-120 rounded-[18px] border border-[#3a3a3a] bg-[#1c1c1c] p-6 shadow-[0_20px_60px_rgba(0,0,0,0.42)]">
            <h3 className="m-0 mb-4 text-base font-semibold tracking-[-0.01em]">新建流水线项目</h3>
            ...
            <textarea
              ...
              rows={5}
              className="mb-5 w-full resize-none rounded-[10px] border border-[#2a2a2a] bg-[#242424] px-3.5 py-2.5 text-[14px] text-[#e5e5e5] outline-none transition-colors placeholder:text-[#666666] hover:border-[#3a3a3a]"
            />
