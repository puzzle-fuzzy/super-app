...
type VideoPrimitiveProps = NodeProps<VideoNodeType> & { title: string }

/**
 * 视频原始模式 — 上传（与 tersa 1:1 对齐）
 */
export function VideoPrimitive({ data, id, type, title }: VideoPrimitiveProps) {
